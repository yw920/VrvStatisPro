...
(function($) {
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function insertLegend() {
            ...
            var table1 = '<table class="table1" style="font-size: 11px;color:' + options.grid.color + '">' + fragments.join("") + '</table>';
            if (options.legend.container != null)
                $(options.legend.container).html(table1);
            else {
                var pos = "",
          ...
          /**      if (p.charAt(1) == "e")
                ...
                var legend = $('<div class="legend">' + table1.replace('style="', 'style="position:absolute;' + pos +';') + '</div>').appendTo(placeholder);
                if (options.legend.backgroundOpacity != 0.0) {
                    ...
                    $('<div style="position:absolute;width:80px;height:' + div.height() + 'px;' + pos +'background-color:transparent;"> </div>').prependTo(legend).css('opacity', options.legend.backgroundOpacity);
                }
            }
        }
