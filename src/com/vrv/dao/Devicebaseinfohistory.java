...
/**
 * Devicebaseinfohistory entity. @author MyEclipse Persistence Tools
 */

public class Devicebaseinfohistory implements java.io.Serializable {
	...
	/** default constructor */
	public Devicebaseinfohistory() {
	}

	/** full constructor */
	public Devicebaseinfohistory(Integer deviceId, String devOnlyId,
			String userName, String deviceName, String numIpaddress,
			String ipaddres, String macAddress, String deptName,
			String officeName, String deviceType, short registered,
			short runStatus, Integer areaId, String cpuType, Integer diskSize,
			String antivirusSoftware, String notInstalledPatch, String ostype,
			Date unInstallTime, String description, Integer devTypeCode,
			String communicatIp, Integer exField6, String assetId,
			String servicePack, Date setupTmos, String clientVersion,
			Integer lockStatu, Integer protectStatu, Integer blockOrNot,
			Integer area2, String subOffice, String room, String tel,
			String email, Date lastTime, Integer memorySize, Integer cpusize,
