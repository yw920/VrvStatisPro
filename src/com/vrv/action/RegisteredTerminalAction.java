...
import com.vrv.service.RegisteredTerminalService;

public class RegisteredTerminalAction {
	private RegisteredTerminalService DLTService;
	...
	public void execute() throws IOException{
		...
		System.out.println("In RegisteredTerminalAction, DLTService.getDeviceDomInfo finished!!!!");
		...
		System.out.println("In RegisteredTerminalAction:iterator.hasNext() start");
    	...
    	System.out.println("In RegisteredTerminalAction:iterator.hasNext() finish");
    	contentsMap.put("code",0);
    	contentsMap.put("IsLastPage",1);
    	contentsMap.put("return",Content);
    	Long IsRegister = this.DLTService.getDeviceDomNum(3, OrgId);
    	Long NoRegister = this.DLTService.getDeviceDomNum(4, OrgId);
    	contentsMap.put("IsRegister", IsRegister);
    	contentsMap.put("NoRegister", NoRegister);
    	contentsMap.put("All", this.DLTService.getDeviceDomNum(0, OrgId));
    	System.out.println("In RegisteredTerminalAction:OrgId:"+OrgId);
    	...
    	if(mdd.size() == 0){//直接传输本部分的信息
    		JSONArray OrgInfo = new JSONArray();
    		OrgInfo.add(0, NoRegister);
    		OrgInfo.add(1, OfficeName);
    		OrgInfos.add(0,OrgInfo);
    	}
    	System.out.println("orginfos："+OrgInfos.toString());
	...
	public RegisteredTerminalService getDLTService() {
		return DLTService;
	}
	public void setDLTService(RegisteredTerminalService dLTService) {
